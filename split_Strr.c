...
/**
 * split_str2 - splits a stringss into an words_counter arrays.
 * @inputed_string: str -> be splsited.
 * @_delim: delimetering
 * @word_counter: wrd2Xs nums in the string
 * Return: string arrss or NULL.
*/
...
char **split_str2(char *inputed_string, const char *_delim, int *word_counter)
{
	...
	copy_str2(str_cpy, inputed_string);
